        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="mb-4">
                Total Pacifique Sàrl, société à responsabilité limitée au capital de 10 000 €, dont le siège social est situé 123 Avenue des Champs-Élysées, 75008 Paris, France, immatriculée au RCS de Paris sous le numéro 123 456 789, est responsable du traitement de vos données personnelles.
              </p>
              <p className="mb-4">
                <strong>Contact :</strong> contact@total-fioul-france.fr
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Pour exercer vos droits, contactez-nous à : contact@total-fioul-france.fr
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                <strong>Email :</strong> contact@total-fioul-france.fr<br/>
                <strong>Courrier :</strong> Total Pacifique Sàrl, 123 Avenue des Champs-Élysées, 75008 Paris
              </p>
              <p className="mb-4">
